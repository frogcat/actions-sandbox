...
test('jisx0401#resolve', function(t) {
  ...
  t.ok(jisx0401.resolve("00") === undefined, "存在しないコードの場合は undefined を返す");
  t.ok(jisx0401.resolve() === undefined, "引数が与えられない場合は undefined を返す");
  t.end();
});
...
test('jisx0401#find', function(t) {
  ...
  t.ok(jisx0401.find("ワシントン") === undefined, "存在しない名称の場合は undefined を返す");
  t.ok(jisx0401.find() === undefined, "引数が与えられない場合は undefined を返す");
  t.end();
});
